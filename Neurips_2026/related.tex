...
%
Some works \cite{Leino,Zhang22a,Sun22,Chen21,REGLO} focus on training a network to be more globally robust, rather than proving the DNN is. They do not focus on the (non-ID) inputs.
