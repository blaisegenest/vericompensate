...
The AE-DNN architectures (Fig.~\ref{fig:AE-DNN}) is novel, projecting the input on a dimensionaly reduced space to filter non ID features \cite{aggarwalOutlierAnalysis2017}.
