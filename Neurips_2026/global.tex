...
the range of values $\hat{y}_j$ can take (see Figure in Appendix) corresponds to solutions of the following {\em 1b} MILP program with binary variable $a \in \{0,1\}$:
	\begin{align*}
