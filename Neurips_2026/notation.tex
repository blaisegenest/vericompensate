...
In this paper, we consider the {\em global} verification problem, where we optimize over all images $I$ and perturbations $I'$ of $I$ with $|I-I'| \leq \varepsilon$. We will consider:
	...
	To encode $L_1$-perturbations, we propose the following new encoding {\em without} extra binary variables. 
...
\quad \, \quad [$L_1$-perturbations $\sum_{j\leq k} |x_j-x'_j| \leq \varepsilon$].
	\end{enumerate}
