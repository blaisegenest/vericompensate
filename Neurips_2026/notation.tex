...
In this paper, we consider the {\em global} verification problem, where we optimize over all images $I$ and perturbations $I'$ of $I$ with $|I-I'| \leq \varepsilon$. We will consider:
	...
	Here are the {\bf set of constraints} to encode the global robustness problem with $L_\infty \leq \varepsilon$ norm:

	\begin{itemize}
	   \item for all {\em input} neuron $j$ (in layer 0), $|x_j-x'_j|\leq \varepsilon$ [$L_\infty$ norm]
