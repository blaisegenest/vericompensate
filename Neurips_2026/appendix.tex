...
\begin{enumerate}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: The whole process of the method and all datasets, models, and hyperparameters are clearly stated in Sections 5, 6, and 7.
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: The DNNs are openly available, as well as the datasets. The algorithms are clearly provided, and results can be replicated using Gurobi as solver using one's preferred code base. We will release the code upon acceptance of the paper.
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: The original owners of assets, code, data, and models used in the paper are properly credited. The license and terms of use are explicitly mentioned and properly respected.
	\item[] Guidelines:
