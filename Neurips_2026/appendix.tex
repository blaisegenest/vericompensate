...
\begin{enumerate}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} For example, the work has not been generalized to larger size of models.
	\item[] Guidelines:
	\begin{itemize}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} The full proofs appear in the supplemental material (appendix).
	\item[] Guidelines:
	\begin{itemize}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} The whole process of the method and all datasets, models and hyperparameters are clearly stated.
	\item[] Guidelines:
	\begin{itemize}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} All datasets, models and hyperparameters are clearly stated.
	\item[] Guidelines:
	\begin{itemize}
		\item The answer \answerNA{} means that the paper does not include experiments.
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} The required information is provided at the beginning of the experimental section.
	\item[] Guidelines:
	\begin{itemize}
		\item The answer \answerNA{} means that the paper does not include experiments.
	...
	\item[] Justification: \justificationTODO{} The work presents a theoretical framework. It does not involve data collection from individuals or system deployment, and therefore does not introduce foreseeable negative societal impacts such as privacy, fairness, or security risks.
	\item[] Guidelines:
	\begin{itemize}
	...
	\item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
	\item[] Justification: \justificationTODO{} The original owners of assets code, data, models used in the paper are properly credited. The license and terms of use explicitly are mentioned and properly respected.
	\item[] Guidelines:
	\begin{itemize}
