...
\begin{document}
	...
	\subsubsection{Cloned model}
	
	The most straight way is to build two identical MILP models $M_1,M_2$ with completely disjoint variables (including inputs and outputs) with some extra constraints: 
