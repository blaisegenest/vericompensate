...
A more direct way to establish the constraints is as follows: \begin{align*}
	& y+x'_i \leq a\beta_i \quad\wedge \quad y+x'_i\geq (1-a)\alpha_i\\	
	...
	&	\hat{y}_i \leq -x'_i+(1-a)\beta_i \quad\wedge \quad	\hat{y}_i \geq -x'_i+(1-a')\alpha_i \\
	&	\hat{y}_i \leq y_i+x'_i+(1-a)(-\alpha_i)\quad\wedge \quad	\hat{y}_i \geq y_i+x'_i+(1-a')(-\beta_i) \\
