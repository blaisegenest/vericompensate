...
\begin{itemize}
	...
	$succ(y,\sigma(y)) \subseteq R_{\delta/2}$.
\end{itemize}

IT will be sufficient to obtain a DT certificate.
Only the third item above is non trivial.

Without loss of generality, we assume the Lipschitz constant for $succ$ is 1. Now we prove the third claim.
...
To prove the third claim, we need to use the definition that $succ$ is also Lipschitz.
