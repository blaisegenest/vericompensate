...
\begin{tikzpicture}
	\begin{axis}[width=10cm,height=5cm,
		xlabel={},
		ylabel={},
		title={runtime (seconds per node)},
...
\begin{table}[]
	...
	\begin{tabular}{|c|c|cc||cc||c|}
		...
		\hline \hline
		$8\times200$\  &   $25\%$? & $72\%$? & $75\%$? & {\color{blue}$75.5\%$?}  & {\color{blue}$\mathbf{77\%}$} & $89\%$? \\ 
		$\epsilon = 0.015$ & 17s & 95s? & 500s? & {\color{blue}391s} & {\color{blue}562s} &\\ \hline
	\end{tabular}
