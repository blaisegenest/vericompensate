...
For DNNs easy to verify, $\alpha$-$\beta$-CROWN and PRIMA are excellent solutions, both very fast and very accurate, usually matching or getting very close to the upper bound on the $\%$ of verified images \cite{crown}. Compensation strength is not required in these contexts, and likely not useful, reason why we did not consider it.
