...
\end{tabular}
\caption{Average uncertainty of $\MILP_Z$ for nodes of the second layer, for $Z$ with $K$ ReLU nodes of the first layer (compensating strenght vs random choice).}
\label{tab:example0}
\vspace{-0.8cm}
\end{table}
...
\end{tabular}
\caption{Average uncertainty of $\MILP_Z$ for nodes of the third layer, for $Z$ with $K$ ReLU nodes of the 1st and 2nd layer (compensating strenght vs random choice).}
\label{tab:example1}
\vspace{-0.8cm}
\end{table}
