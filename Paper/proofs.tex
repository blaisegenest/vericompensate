...
\section{Proof of Theorem \ref{th2}}
			...
			\begin{proof}	
				...
				edges from $m \in D_J$ to $n$ are replaced by a bias (equals to the weight of the edge times the fix value $\val_{\boldsymbol{x}^0_J}(m)$) for $n$ (we summ all these bias for a neuron $n$).
