...
\section{Proof of Theorem \ref{th2}}
			...
			Let $[\alpha,\beta]$ be the bounds computed by $\MILP_{X}$ for the target node $z$. We want to show that $\beta= \max(z)$. 
...
We are now ready to finish the proof of Theorem \ref{thm:2}.
