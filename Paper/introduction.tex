...
verifying more than $20\%$ more images than $\alpha,\beta$-CROWN \cite{xu2020fast} (or PRIMA \cite{prima}) on the larger $6 \times 500$ DNN trained naturally (Table \ref{tab:example3}).}
