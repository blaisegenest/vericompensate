\section{Notations and Preliminaries}
    ...
    $\hat{y}_i = \ReLU(x_j-x'_j)$), similarly than in the ITNE model \cite{lipshitz}. 
    \end{itemize}
...
\end{proposition}
    ...
    Let $\mathcal{M}$ denote the whole MILP model, where each unstable ReLU are encoded in the above way with one integer variable. 
