...
This results into usable bounds, allowing in real time to certify robustness for $>87\%$ of incoming images 
in the MNIST benchmark for a L1 perturbation of $\frac{1}{2}$, as well as for a surrogate computing the hidden plastic strain 
