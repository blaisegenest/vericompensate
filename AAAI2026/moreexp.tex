...
runtime to obtain better bounds. We did experiment the "3v" model with an extended time-out at 129600s, which does improve the bounds by around $10\%$, as well as the number of images certified robust in real-time, Table~\ref{table.cert}.
...
\begin{table}[t!]
	\begin{tabular}{||l||c|c|c|c||}\hline\hline
		...
		3vEx, $500 \times 3$ & {\bf 89\%} & {\bf 65\%} & {\bf 29\%} & {\bf 11\%} \\\hline\hline
	\end{tabular}
