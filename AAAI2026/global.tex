    ...
    The idea to circumvent the loss of dependencies when applying linear relaxation is to switch the variables towards 
    $x'_j,\hat{x}'_j, y_j, \hat{y}_j$, where $y_j, \hat{y}_j$ are the {\em diff variables}, with
