...
in practice, Table \ref{table_complete} reveals that only NNenum succeds to verify 9\% more images out of the 50\% undecided images by $\alpha,\beta$-Crown, and with a very large runtime of almost 5000s per image. It seemed pointless to test complete verifiers on larger networks.
