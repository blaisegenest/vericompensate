...
\begin{table}[b!]
	...
	\begin{tabular}{||l|c|c||c|c|c||}
		...
		MNIST 6$\times$100 & 99\% & 90\% & 28\% & $\approx 30\%$ & 40 \%    \\
...
\begin{enumerate}
	\item  Our first contribution is to study LP relaxations for the complete MILP
	encoding of ReLU-DNNs. We establish in Theorem \ref{th1} the abstraction set corresponding to the LP constraints.
	\item This allows us to propose a measure of utility for each neuron
	
	foundational understanding that the compensating pairs are the 	%primary 
	source of {\em all} inaccuracies, 
	 ...
	 DNNs easier to verified have less compensation strength than verification agnostic DNNs. 
...
We consider DNNs employing the standard ReLU activation function, though our findings potentially extend to more sophisticated architectures. 
