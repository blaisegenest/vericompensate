...
\begin{figure}[t!]
	...
	\caption{Time and uncertainty scaling of table \ref{table15}.
		Time is using logscale.}
	\label{fig3LP}
\end{figure}
...
\subsection{Table for Figure \ref{fig_table3}}

Finall, we provide the table corresponding to the Figure \ref{fig_table3}
