...
Further, we tested with the SR  and FSB heuristics \cite{BaB} to choose important nodes for BaB (Branch and Bound).
SR and FSB result in particularly low accuracy, even worse than \cite{DivideAndSlide} which only focus on neurons one layer before, and far away from Utility. FSB is also performing worse than SR when choosing nodes for pMILP, while for BaB, it is the opposite situation.
This means that the heuristic to choose nodes important for BaB is not adapted to choose nodes for pMILP, although \cite{DivideAndSlide} heuristic is also choosing neurons based on importance of neurons for the consider ReLU.
...
\begin{table}[h!]	
	...
	\begin{tabular}{|c||c|c|c||c|c|c|c|}
		...
		5  &   1.729&1.704 & 1.603&  1.729& 1.7138 & 1.7182 & \bf 1.532 \\ \hline
		10  &  1.701 &  1.651 &1.517& 1.696 & 1.6775& 1.6803 & \bf  1.371\\ \hline
		15  & 1.671 &  1.599 &1.466&  1.653& 1.6392& 1.6475 & \bf  1.247\\ \hline
		20  &  1.635 & 1.557&1.438 & 1.619 &1.5938 & 1.6174 & \bf  1.145\\ \hline
		25  &  1.601 & 1.519 &1.427&  1.586 &1.5534 & 1.5788 & \bf 1.061\\ \hline
		30  & 1.574 & 1.489 &1.425& 1.546 & 1.5166& 1.5413 & \bf  0.989 \\ \hline
		35  &  1.542 & 1.465&1.424 & 1.502 & 1.4788 & 1.4972 & \bf 0.934 \\ \hline
		40  & 1.512 & 1.447 &1.424& 1.469 & 1.4395& 1.4514 & \bf 0.921 \\ \hline \hline
