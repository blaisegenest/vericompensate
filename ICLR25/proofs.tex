...
We run MnBAB on several networks that we considered on our device. The comparison is as follows:
...
Basically, PRIMA is slightly less accuracy and slower than $\alpha,\beta$-Crown for several networks we considered. 
