...
However, the experiments section in their paper does not include those network we focus on. So we run MnBAB on several networks on our device. The comparison is as follows:

\begin{table}[h]
	\centering
	\begin{tabular}{||l|c|c||c|c||}
		\hline
		Network &  Accuracy & Upper   & MNBaB &  $\alpha,\beta$-Crown  \\ \hline
