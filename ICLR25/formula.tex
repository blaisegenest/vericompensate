...
that is how much a ReLU value impacts the value of $z$, and rank the ReLU nodes accordingly. This is the case of \cite{DivideAndSlide}, but also more generally of heuristics for BaB \cite{BaB,ferrari2022complete}, such as SR and FSB. %Our Utility function does not follow this approach. 
