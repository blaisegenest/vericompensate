...
To estimate $\Improve\_max_a^z$, we define $\Utility$\_max$^z(a)$, first for neurons $a$ one layer before $z$:
...
We define a difference $\Delta$ to account for the fact that a neuron $b$ 
