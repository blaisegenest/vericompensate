...
\begin{table}[t!]	
	...
	\begin{tabular}{|c||c|c|c|c|}
		\hline
		\text{Number $K$}  &  \text{Without ratio} &\text{With ratio} &  \text{Incoming Weights} \cite{ DivideAndSlide} & \text{Random} \\ \hline
		\hline
		0  &   1.761  & 1.761 & 1.761 & 1.761  \\ \hline
		5  & 1.532  & 1.533 & &   \\ \hline
		10  & 1.371 & 1.373 & 1.651 & 1.696  \\ \hline
		15  & 1.247 & 1.244 &   &   \\ \hline
		20  & 1.145 & 1.136 & 1.557 & 1.619  \\ \hline
		25  & 1.061 & 1.057 &  &   \\ \hline
		30  & 0.989 & 1.067 & 1.489 & 1.546  \\ \hline
		35  & 0.934 & 1.091 &  &   \\ \hline
		40  &  & & 1.447 & 1.469  \\ \hline
		50  &  & & 1.426 & 1.388  \\ \hline
		116 (max) &  0.895 & 0.895 & 1.424 (max=$61$) & 0.895  \\ \hline
	\end{tabular}
	\caption{Average uncertainty of $\MILP_Z$ for nodes of the third layer, for $Z$ with $K$ ReLU nodes of the 1st and 2nd layer (compensating strength vs \cite{ DivideAndSlide} vs random choice).}
	\label{tab:example1}
	\vspace{-0.6cm}
\end{table}
