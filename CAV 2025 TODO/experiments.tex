...
\begin{table}[t]	
	...
	\begin{tabular}{|c||c c|c c|c c|}
		\hline
		  & \multicolumn{2}{c|}{30 open ReLUs} & \multicolumn{2}{c|}{45 open ReLUs} & \multicolumn{2}{c|}{60 open ReLUs} \\ 
		 order & uncert & time & uncert & time & uncert & time \\
		\hline \hline
		Gurobi &   3.987  & 260s  & 4.016 & 266s& 4.053 & 262s\\ 
		SAS &   3.989  & 264s  & 4.031 & 266s& 4.060 & 263s\\
		FSB &   3.988  & {\bf 246s}  & 4.018 & {\bf 248s}& 4.033 & {\bf 248s}\\ \hline
	\end{tabular}
	\caption{Comparison of different ordering with selection of ReLUs by SAS.}
	\label{table.order}
	%\vspace{-0.6cm}
\end{table}
