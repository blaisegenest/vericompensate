...
{\color{red}Notice that above definitions only involve weights, and do not use bias. From the following lemmas and proofs, we can find that our discussion is irrelevant to bias, no matter the bias are very large positive or negative, or very close to 0.}
...
{\color{red} As we mentioned before, this proof does not have any requirements on the bias.}
