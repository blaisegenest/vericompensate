...
Notice that above definitions only involve weights, not bias. From the following lemmas and proofs, we can find that our discussion is irrelevant to bias, no matter the bias are very large positive or negative, or very close to 0.
...
\section{Proof of Theorem \ref{th2}}
			...
			Similarly, this definition does not involve bias, and any kind of bias will not influence our theorem.
