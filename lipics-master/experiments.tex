...
with 256 GB of main memory and an (unused) NVIDIA RTX 3090. 
...
\begin{itemize}
	\item DeepPoly \cite{deeppoly}/ CROWN \cite{crown}. We report the runtime from our  implementation in \toolname. 
...
\begin{table}[t!]	
	...
	\begin{tabular}{|c||c|c|c|}
		\hline
		\text{Number $K$}  &  \text{Compensate layer} 1+2 &  \text{{\color{red}Quick Method} layer} 2 & \text{Random layer } 1+2 \\ \hline
		\hline
