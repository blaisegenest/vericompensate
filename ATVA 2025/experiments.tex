...
Then, to measure the impact of the scoring function to select neurons to open, 
...
\begin{table}[t!]	
	...
	\begin{tabular}{|c||c c|c c|c c|c c|}
		...
		\hline \hline
		Gurobi & 0.384 & 252s & 0.368&265  &0.342 & 287& 0.315  & 306s  \\ 
		SAS (static) & 0.384 & 448s & 0.368&759  &0.365 &971 & 0.355  & 971s \\
		GS (static) & 0.384 & {\bf 251s} &0.368 &{\bf 253}  & 0.342 &{\bf 270} & 0.315 & {\bf 281s} \\ \hline
	\end{tabular}
...
However, the GS {\em ordering} (with the SAS {\em selection}) is better as it is general and not local to a solution, with better runtime than Gurobi, despite its staticness whereas Gurobi order is adaptative. Using SAS order for the solution branch, and GS ordering for other branches should be more efficient, but we cannot experiment that within the closed-source Gurobi solver.
