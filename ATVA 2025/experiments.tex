...
choice of the $K$ heaviest neurons of {\sf SAS}, compared with a random choice, with Huang \cite{DivideAndSlide}, based on strength$(n) = (\UB(n)-\LB(n))\cdot |W_{nz}|$, and with GS (here, $s_{FSB}$).
