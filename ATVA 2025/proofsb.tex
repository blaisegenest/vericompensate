...
\begin{figure}[b!]
	\hspace*{-0.8cm}
	\includegraphics[scale=0.55]{CNN-B-ADV_layer7_comparison_image85_min.png}
	\caption{Distance to verify vs runtime: comparison between SAS and GS for different number of ReLUs open.}
	\label{fig55}
\end{figure}
