...
We call {\em global scoring} (GS) these functions $s_{FSB},s_{SR}$  because they score ReLUs as \textcolor{red}{accurately} as possible, considering that they do not have access to the values 
