...
\cite{pyrat}, respectively 4th, 3rd and 2\textcolor{red}{nd} of the last VNNcomp'24 \cite{VNNcomp24}
and 5th, 2\textcolor{red}{nd} and 3rd  of the VNNcomp'23 \cite{VNNcomp23}; MnBAB \cite{ferrari2022complete}, 2\textcolor{red}{nd} in VNNcomp'22 \cite{VNNcomp22}, built upon ERAN \cite{deeppoly} and PRIMA \cite{prima}; and importantly, $\alpha,\beta$-CROWN \cite{crown,xu2020fast}, the winner of the last 4 VNNcomp, benefiting from branch-and-bound based methodology \cite{cutting,BaB}.
...
\begin{table}[t!]
	...
	\begin{tabular}{||l|c|c|c||c|c|c||}
		\hline
		Network & nbr & Accuracy \textcolor{red}{$^*$}  & Upper  \textcolor{red}{$^*$}& $\alpha,\beta$-CROWN& $\alpha,\beta$-CROWN & $\alpha,\beta$-CROWN \\ 
	...
	\begin{minipage}{0.9\linewidth}
		\footnotesize
		\textcolor{red}{\textsuperscript{*} Accuracy means the accuracy of the network itself on test set, and Upper Bound is 100\% the percentage of unsafe examples.} \\
	\end{minipage}
