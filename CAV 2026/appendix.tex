...
\begin{proof}[of Proposition 3] First, we list the inequalities: \begin{align*}
	...
	\end{align*} Now we can see, $y_i\leq 0$ (line 1). Line 2 implied by other inequalities since \begin{align*}
	...
	\end{align*} Now we can see, $y_i\geq 0$ (line 2). Line 1 implied by other inequalities since \begin{align*}
