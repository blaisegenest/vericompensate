...
\section{A table comparing PCA and FULL}
	...
	\begin{tabular}{|c|c||c|c|c|}\hline
		Network & Target & PCA Dim  & Full Dim& Ratio ($\%$) \\\hline \hline 
		MNIST-FC  & $L_1, \beta$ & 2.18 & 37.24 & 5.85\\\hline
		MNIST-FC  & $L_\infty, \beta$ & &  &\\\hline
		MNIST-FC  & $L_\infty, \alpha$ & &  &\\\hline\hline
		
		MNIST-Conv1  & $L_1, \beta$ &  &  &\\\hline
		MNIST-Conv1  & $L_\infty, \beta$ &  &  &\\\hline
		MNIST-Conv1  & $L_\infty, \alpha$ & 3.16 & 10.14  & 31.17\\\hline\hline
		
		FMNIST-Conv1  & $L_1, \beta$ & 2.34 & 7.43  & 31.49\\\hline
		FMNIST-Conv1 & $L_\infty, \beta$ & 21.22 & 25.55  & 83.05\\\hline
		FMNIST-Conv1  & $L_\infty, \alpha$ & 20.79 & 22.42  & 92.73\\\hline\hline
		
		CIFAR-10-Conv1  & $L_1, \beta$ & 1.56 & 7.19 & 21.70 \\\hline
		CIFAR-10-Conv1  & $L_\infty, \beta$ & 10.45 & 22.38  & 46.69\\\hline
		CIFAR-10-Conv1  & $L_\infty, \alpha$ & 6.67 & 22.77  & 29.29\\\hline
	\end{tabular}
	\caption{
	}
\end{table}
