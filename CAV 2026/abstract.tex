Deep neural networks (DNNs) are often brittle to small perturbations, leading to extensive research to verify their robustness. 
Most existing methods focus on {\em offline local} robustness, i.e., the model's behavior in the neighborhood of specific inputs. Local robustness 
