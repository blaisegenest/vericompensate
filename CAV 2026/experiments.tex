...
With that, we can guarantee at least $70\%$ of the images as certified
for all 3 PCA-DNN label  for a $L_1$-perturbation of $1$, and even go up to perturbation $2$ for CIFAR10 and even $4$ for FMNIST.
...
PCA is extremely efficient at helping verify.
