...
\begin{table}[t!]
	...
	\\
	 LB $\underline{\alpha}$= & 14400s & up. Bound $\overline{\alpha}$ $\downarrow$ & 17.54 & 11.15 & {\bf \em 10.14} & {\em 10.29} & {\em \bf 10.07}
    \\
	...
	LB $\underline{\alpha}$= & 14400s & up. Bound $\overline{\alpha}$ $\downarrow$ & 37.26 & 24.06 & {\bf \em 22.42 } & {\em  23.80} & {\em \bf 22.34}
    \\
	...
	LB $\underline{\alpha}$= & 14400s  & up. Bound $\overline{\alpha}$ $\downarrow$ & 31.53* & 22.73 & {\bf \em 21.77} & {\em 21.81} & {\em \bf 20.38}
    \\
...
\begin{table}[h!]
	\centering
	\begin{tabular}{||c||c|c|c|c||c|}\hline\hline
		Benchmark & $L_1=1$ & $L_1=2$ & $L_1=3$ & $L_1=5$ & Latency overhead 
		
		\\\hline \hline
		MNIST-FCNN  & 0$\%$ & 0$\%$ & 0$\%$ & 0$\%$ & 0.5ms
		
		\\\hline
		PCA-MNIST-FCNN  & 69 $\%$ & 16 $\%$ &  $\%$ &  $\%$ & 0.5ms
		\\ \hline \hline
		...
		\\\hline
		PCA-CIFAR10-C1  & 88 $\%$ & 69 $\%$& 59 $\%$ & 46 $\%$ & 0.5ms
		\\\hline \hline
	\end{tabular}
