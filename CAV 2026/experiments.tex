...
\begin{table}[h!]
	...
	\begin{tabular}{||c||c||c|c|c||c|}\hline\hline
		...
		FMNIST-CNN1 & Bound $\downarrow$ & 3.02 & 3.02 & 2.74 & 2.74
		\\
		TO=1000s & $\%$ of gap $\downarrow$ & 221 $\%$  & 222 $\%$ & 190 $\%$ & 190 $\%$
		\\\hline 
		
		
		TO=14400s & Bound $\downarrow$ & 2.34 & 1.95 & 2.52 & 1.95
		\\
		& $\%$ of gap $\downarrow$ & 148 $\%$  & 107 $\%$ & 166 $\%$ & 107 $\%$
		\\\hline \hline
		
		
		CIFAR10-CNN1  & Bound $\downarrow$ &&&&
		\\
		TO=1000s & $\%$ of gap $\downarrow$ &&&&
		\\\hline
