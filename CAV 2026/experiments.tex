...
With that, we can certify at least $70\%$ of the images for all 3 PCA-DNN label for a $L_1$-perturbation of $1$, and even up to perturbation $2$ for CIFAR10 and even $4$ for FMNIST. We are unable to do it for the non-PCA version, but in the case of FMNIST-Conv, with a perturbation 4 times smaller than for its PCA-version. \eca{Overall, PCA improves tremendously real-time verification.}
