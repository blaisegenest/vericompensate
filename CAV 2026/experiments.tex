...
\begin{table}[h!]
	...
	MNIST-C1  & Bound $\downarrow$ & 20.51 & 12.77 & {\bf 11.59} & &
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & 118 $\%$ & 35 $\%$ & {\bf 23} $\%$ & &
	\\ \hline
	TO=14400s  & Bound $\downarrow$ & ? & ? & {\bf ?} & &
    \\
	 & $\%$ of spread $\downarrow$ & ? $\%$ & ? $\%$ & {\bf ?} $\%$ & &
    
    \\\hline \hline

	FMNIST-C1 & Bound $\downarrow$ & 41.52 & 27.57 & {\bf 23.67} & &
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & 93 $\%$ & 24 $\%$ & {\bf 6} $\%$ & &
    \\\hline 


	TO=14400s & Bound $\downarrow$ & 37.26 & 24.56 & {\bf 22.56} & &
    \\
	 & $\%$ of spread $\downarrow$ & 72 $\%$ & 10 $\%$ & {\bf 1} $\%$ & &
    \\\hline \hline
