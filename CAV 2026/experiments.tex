...
\begin{table}[h!]
	...
	FMNIST-C1 & Bound $\downarrow$ & 41.52 &  & {23.27\bf } & 24.09 & 22.78
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & 93 $\%$ &  $\%$ & {\bf 5} $\%$ & 10 $\%$ & 3 $\%$
    \\\hline 


	TO=14400s & Bound $\downarrow$ & 37.26 &  & {22.42\bf } & 23.80 & 22.34
    \\
	 & $\%$ of spread $\downarrow$ & 72 $\%$ &  $\%$ & {1\bf } $\%$ & 9$\%$ & 0.6$\%$
    \\\hline \hline
