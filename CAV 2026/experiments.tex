...
\begin{table}[h!]
	...
	MNIST-C1  & Bound $\downarrow$ &  & 12.32 & {11.14} & {\bf 10.95} & 10.85
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & $\%$ & 29 $\%$ & {17} $\%$ & {\bf 15} $\%$& 14 $\%$
	\\ \hline
	TO=14400s  & Bound $\downarrow$ &  & 11.15 & 10.14 & 10.29 & 10.07
    \\
	 & $\%$ of spread $\downarrow$ &  $\%$ & 17 $\%$ & 7 $\%$ & 8 $\%$ & 6 $\%$ 
