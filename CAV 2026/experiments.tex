...
\begin{table}[h!]
	...
	CIFAR-C1  & Bound $\downarrow$ & ? & 27.15 & 25.94 & {\bf 24.52}& 23.29
    \\
	TO=1000s & $\%$ of gap $\downarrow$ & ? & 28 $\%$ & 24 $\%$& 
	{\bf 20} $\%$ & 15 $\%$
	\\\hline
    
	TO=14400s  & Bound $\downarrow$ & ? & 22.73 & {\bf 21.77} & 21.81 & 20.38
    \\
	 & $\%$ of gap $\downarrow$ & ? & 12 $\%$ & {\bf 10} $\%$& {\bf 10} $\%$& 5$\%$
		\\\hline \hline
