...
perturbation they consider (here $L_\infty=0.05$) on their DNNs (here Conv for MNIST, FMNIST and CIFAR-10), for which the reduction rules of binary variables are implemented. We test with 1000s Time-Out, as well as one test with 14400s time out, showing that much longer time-out does not have a big impact on the result.
...
\begin{table}[h!]
	...
	\begin{tabular}{|cc|c c c|c|}\hline
		$L_1=1$ & Timeout & {\em Diff} & {\em 2b+1} & {\em 1b} & {\em Best} \\\hline \hline 
		MNIST-FC  & 1000s & 38.88 & 38.68 & {\bf 37.34} & {\bf 37.33}
		\\
		LB $\underline{\beta}$= 0.50 & 14400s & 37.24 & 36.96 & {\bf 33.68} & {\bf 33.67}
		
		\\\hline
		PCA-MNIST-FC  & 1000s & {\bf 2.43} & {\bf 2.43} & 2.68 & {\bf 2.41}
		\\
		LB $\underline{\beta}$= 0.12 & 14400s & 2.18 & {\bf 2.00} & 2.46 & {\bf 2.00}
		\\ \hline \hline
		
 		FMNIST-Conv & 1000s & 8.90 & {\bf 7.55} & 9.84 & {\bf 7.55}
		\\
		LB $\underline{\beta} = 4.16$ & 14400s & 7.43 & {\bf 6.37} & 9.62 & {\bf 6.22}
		\\\hline

		PCA-FMNIST-Conv & 1000s & 3.02 & 3.02 & {\bf 2.74} & {\bf 2.74}
		\\
		...
		CIFAR10-Conv  & 1000s &8.30 & {\bf 8.14} & 8.17 & {\bf 7.77}
		\\
		LB $\underline{\beta}= 2.12$ & 14400s & {\bf 7.19} & 7.45 & 7.31 & {\bf 6.67}
		\\\hline
		PCA-CIFAR10-Conv  & 1000s & 1.18 &&&
		\\
...
\begin{table}[h!]
	...
	\begin{tabular}{||c||c|c|c|c||c|}\hline\hline
		...
		\\\hline
		PCA-CIFAR10-Conv  & 88 $\%$ & {\bf 69} $\%$& 59 $\%$ & 52 $\%$ & 0.5ms
		\\\hline \hline
	\end{tabular}
