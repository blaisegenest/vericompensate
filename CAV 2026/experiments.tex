\section{Experimental Evaluation}
	...
	ITNE \cite{ITNE} was reimplemented using the same path as our code, except for the MILP variable $x_j$ using the classical MILP encoding plus the extra linear constraint Eq.~(\ref{eq.lpr}). The original Vhagar code \cite{vhagar} was run on the same hardware.
