...
\begin{table}[h!]
	...
	\begin{tabular}{|cc| c | c c c|c|}\hline
		...
		\\\hline
		PCA-MNIST-FC  & 1000s & 2.50 & {\bf 2.43} & {\bf 2.43} & 2.68 & {\bf 2.41}
		\\
		LB $\underline{\beta}$= 0.12 & 14400s & 2.27 & 2.18 & {\bf 2.00} & 2.46 & {\bf 2.00}
		\\ \hline \hline
		...
		\\\hline
		PCA-CIFAR10-Conv  & 1000s && 1.63 & 1.54 & {\bf 1.28} & {\bf 1.28}
		\\
		LB $\underline{\beta}$= & 14400s && 1.56 & 1.52 & {\bf 1.15} & {\bf 1.15}
		\\\hline
