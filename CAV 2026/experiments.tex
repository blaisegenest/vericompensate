...
\begin{table}[h!]
	...
	Benchmark & model & Vhagar &  ITNE & {\em Diff} & {\em 2b+1} & Best \\\hline \hline
	MNIST-C1  & Bound $\downarrow$ &  20.80 & 12.32 & {11.14} & {\bf 10.95} & 10.85
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & 120$\%$ & 29 $\%$ & {17} $\%$ & {\bf 15} $\%$& 14 $\%$
	\\ \hline
	TO=14400s  & Bound $\downarrow$ & 17.54 & 11.15 & 10.14 & 10.29 & 10.07
    \\
	 & $\%$ of spread $\downarrow$ &  84$\%$ & 17 $\%$ & 7 $\%$ & 8 $\%$ & 6 $\%$ 
    
    \\\hline \hline

	FMNIST-C1 & Bound $\downarrow$ & 41.52 & 26.61 & {23.27\bf } & 24.09 & 22.78
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & 93 $\%$ & 20 $\%$ & {\bf 5} $\%$ & 10 $\%$ & 3 $\%$
    \\\hline 


	TO=14400s & Bound $\downarrow$ & 37.26 & 24.06 & {22.42\bf } & 23.80 & 22.34
    \\
	 & $\%$ of spread $\downarrow$ & 72 $\%$ &  9 $\%$ & {1\bf } $\%$ & 9 $\%$ & 0.6 $\%$
    \\\hline \hline
	

	CIFAR-C1  & Bound $\downarrow$ & ? & 27.15 & 25.94 & {\bf 24.52}& 23.29
    \\
	TO=1000s & $\%$ of spread $\downarrow$ & ? & 28 $\%$ & 24 $\%$& 
	{\bf 20} $\%$ & 15 $\%$
	\\\hline
    
	TO=14400s  & Bound $\downarrow$ & ? & 22.73 & {\bf 21.77} & 21.81 & 20.38
    \\
	 & $\%$ of spread $\downarrow$ & ? & 12 $\%$ & {\bf 10} $\%$& {\bf 10} $\%$& 5$\%$
		\\\hline \hline
