...
\begin{table}[h!]
    ...
    \\
     ...
     \end{tabular}
	\caption{Comparison with Vhagar for $L_\infty=0.05$ perturbation, average over all bounds $\beta_{i,j}$. {\em Best} uses the best between our {\em Diff} and our {\em 2b+1} for each $i,j$. Lower gaps using {\em Best} means that there are cases where {\em Diff} is much better than {\em 2b+1}, and cases where it is the opposite.}
    \label{table.classical}
\end{table}
