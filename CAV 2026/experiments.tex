...
The spread is the average over all cases of the relative distance between the bound to the highest worst-case for that case.
...
\begin{table}[h!]
	...
	FMNIST & Vhagar &  ? &  ? & ? & ?
    \\
	F-Conv1  & ITNE &  $27.57$ &  $22.12$ & $22.12$ & 23 $\%$
	\\ 
    TO=1000s & "2v" &  {\bf 23.67} &  $22.31$ &  $22.31$ & {\bf 6 $\%$}
    \\\hline 


	FMNIST & Vhagar &  $37.01$ &  $22.06$ & $22.06$ & 67 $\%$
    \\
