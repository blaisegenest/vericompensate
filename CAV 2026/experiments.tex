...
perturbation they consider (here $L_\infty=0.05$) on their DNNs (here Conv1 for MNIST, FMNIST and CIFAR-10), for which the reduction rules of integer variables are implemented. We test with 1000s Time-Out, as well as one test with 14400s time out, showing that much longer time-out does not have a big impact on the result.

\begin{table}[h!]
	\centering
	\begin{tabular}{||c|c|c|c|c||}\hline\hline
	Benchmark & model &        Bound $\downarrow$ &  Sol. &      Worst-Case $\uparrow$ \\\hline \hline
	MNIST   & Vhagar &  & & 
    \\
	M-Conv1 & ITNE &  & & 
	\\ 
	...
	FMNIST & Vhagar &  ? &  ? & ? 
    \\
	F-Conv1  & ITNE &  $29.17$ &  $22.55$ & $22.55$
	\\ 
    TO=1000s & 2v &  {\bf 23.08} &  $23.02$ &  $23.02$ 
    \\\hline 


	FMNIST & Vhagar &  $37.01$ &  $22.06$ & $22.06$ 
    \\
	F-Conv1  & ITNE &  $29.17$ &  $22.55$ & $22.55$
	\\ 
    TO=14400s & 2v &    {\bf 22.84} &  $22.53$ &  $22.53$ 
    \\\hline 
