...
Our {\em Diff} model is not only accurate for classification. It can also provide upper bounds on the output of learnt regressor from small perturbation of the input.
