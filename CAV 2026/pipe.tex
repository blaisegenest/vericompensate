...
\end{figure*}	
    ...
    The bounds we found are quite accurate, with a best bound of $0.0329$ obtained by the {\em $2b+1$} model, slightly better than the bound $0.0337$ found within the same time by the {\em Diff} model, and better than the bound found $0.356$ by the {\em $1b$} model, although this bound has been found 70 times faster due to the simpler model ({\em 1}$b$ converges after 1000s). ITNE is significantly worse than even the {\em $1b$} with 1000 s of timeout, at $0.416$ despite a very long timeout. The certified lower bound is not too far, at $0.025$.
