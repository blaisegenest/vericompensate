...
\subsection{The classical encoding of ReLUs for global robustness}
	...
	depending on $y_j$ and on $x'_j$ \eca{for the \emph{Diff} MILP encoding}.}
	\label{fig.2v}
\end{figure}
...
\eca{As explained in the introduction, our objective is to compute upper and lower bounds for 
