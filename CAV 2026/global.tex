...
$\beta^{\varepsilon}_{C,D} = \max_{|I-I'| \leq \varepsilon}(x_C - x_D +x'_D - x'_C)$, for $x_C,x_D$ the value associated with output neurons $C,D$ from any input image $I$, and $x'_C,x'_D$ from its perturbed image $I'$. 
