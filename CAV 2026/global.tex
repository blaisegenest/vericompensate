...
We use $n$ additional linear variables $(A_i)_{i \leq n}$, with the following  constraints:
...
Equations not mentionned are mooot, as shown in the appendix.
	\qed
\end{proof}
...
\end{figure}
	...
	As the {\em 1b} model is a projection of the {\em Diff} model and also of the {\em 2b+1} models, 	the LP relaxations of the {\em Diff} and the {\em 2b+1} models contain (\ref{eq.lpr}).  Proof of Prop.~\ref{prop3} is in appendix.
