...
Global upper bounds $\bar{\beta}$ obtained across the entire input space tend to be overly pessimistic, since they must accommodate all possible inputs, including out of distribution (OOD) \cite{OOD} samples far from the training dataset. Worst-case for $\bar{\beta}$ are indeed produced by such OOD 
...
With PCA, the worst-case are more "natural" (ID) wrt the dataset (see Fig.~\ref{fig4}).
