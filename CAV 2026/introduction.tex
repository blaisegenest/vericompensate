...
\begin{enumerate}
	...
	we develop two abstract MILP models, which are more efficient but also possibly less accurate. Namely, the "2b+1" model, decoupling one binary variable into 2 variables: 1 binary and the other using linear relaxation; while the "1b" model has a unique binary variable per ReLU, only considering the {\em diff variables}.
