...
computes the small values of the {\em diff variables} as the difference between 2 larger values, which is {\em asymptotically} exact but results in poor {\em practical} accuracy \cite{diff}: the {\em Diff} model is more accurate in practice, with the same number of variables.
\iffalse
