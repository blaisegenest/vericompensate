...
\label{s.L1}
	...
	To encode an $L_1$-perturbation, we propose the following encoding {\em without} extra binary variables. Surprisingly, we could not find any reference to such an encoding in the literature.
