...
The (L)AE-DNN architectures (Fig.~\ref{fig:AE-DNN} in Section \ref{sec.pca}) project the input on a dimensionally reduced space to filter out non-ID features \cite{aggarwalOutlierAnalysis2017}.
