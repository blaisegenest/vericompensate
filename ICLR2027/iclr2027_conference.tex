...
non-ID inputs (see Fig. \ref{fig3}). On vanilla DNN architecture, real-time certification is not be possible (lower bounds imply that), irrespective of the computational method used.
