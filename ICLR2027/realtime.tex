...
The associated MILP {\bf objective function} is:
Maximize $x_C - x'_C + x'_D - x_D$ subject to the constraints above.
...
\begin{enumerate}  
  ...
  a bit $b_D=1$ iff
  $x_D+\bar{\beta}^{\varepsilon}_{C,D} \geq x_C$.
...
The proof or Prop. \ref{prop.realtime} can be found in Appendix 
\ref{app.realtime}.
...
For $k=10$ classes (cases of MNIST, Fashion MNIST and CIFAR-10), it amounts to 27 operations in total: $(k-1)$ ADD(+), 
