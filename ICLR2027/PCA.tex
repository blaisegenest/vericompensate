...
on LAE-DNN is 6 times smaller than on DNN, and corresponds to more ID images; see Fig.~\ref{fig3} (right). \eca{In addition, the LAE-DNN can have the same architecture as the original DNN: its linear transformation can be absorbed into the DNN's first layer's weights (see Appendix XXX).}
