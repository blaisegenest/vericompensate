...
An optimal choice of LAE-encode is the projection of the input to these $n$ vectors. That is, calling LAE-decode and LAE-encode filters out features not in the ID latent space.
...
{\em Online:} on any input, LAE-DNN performs inference, 
