...
\begin{document}
	...
	\end{align*} 
	In our practice of global robustness of computation, we will compute an optimization question respect to a certain number $\varepsilon$:	\begin{align}\label{global_robustness}
