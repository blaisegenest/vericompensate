...
\end{enumerate}
	...
	\subsection{Improvement of the simplified model}
...
%	Moreover, we can add two more natural constraints: $x_i'+y_i \geq \alpha_i \hspace*{1ex}\wedge\hspace*{1ex}  x_i'+y_i \leq \beta_i.$
	...
	The accurate constraints for $\hat{y}_i = \ReLU(x'_i+y_i)-\ReLU(x'_i)$ (together with$\hat{x}'_i=\ReLU(x'_i)$) are the follows: \begin{align*}
